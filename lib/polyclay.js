...
PolyClay.Model.buildClass = function(options, methods)
{
	...
	sub.prototype.__init = options._init;
...
PolyClay.validate = {
	...
	'date': _.isDate,
	'hash': _.isObject,
	'reference': function(item) { return _.isString(item) || (item === undefined); },
};
...
{
	if (!this.__dirty || !this.__attributesPrev)
		return false;
